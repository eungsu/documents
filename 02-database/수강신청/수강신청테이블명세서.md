...
| PROF_POSITION | VARCHAR2(20) | YES | | 교수직위 (시간강사, 전임강사, 조교수, 부교수, 정교수) | 체크  |
| DEPT_CODE | CHAR(4) | YES | | 학과코드 | 외래키 |
...
| STUDENT_GRADE | NUMBER(1) | NO | | 학년 | 체크 |
| DEPT_CODE | CHAR(4) | NO | | 소속학과코드 | 외래키 |
...
| LECTURE_TERM | NUMBER(1) | NO | | 강의 개설학기 (1:1학기, 2:2학기, 3:계절학기) | 체크  |
| LECTURE_TYPE | NUMBER(1) | NO | | 강의종류 (1:교양선택, 2:교양필수, 3:전공선택, 4:전공선택) | 체크 |
| LECTURE_GRADE | NUMBER(1) | NO | | 강의 수강대상 학년 | 체크 |
...
| STUDENT_NO | NUMBER(6) | YES | | 학생번호 | 외래키 |
| LECTURE_NO | NUMBER(6) | YES | | 강의번호 | 외래키 |
| REGISTRATION_CREATE_DATE | DATE | | SYSDATE | 수강신청정보 등록일 | |

## 시험성적정보 테이블(SCHOOL_EXAMS)
| 컬럼명 | 데이터타입 | NOT NULL | 기본값 | 설명 | 제약조건 |
| --- | --- | --- | --- | --- | --- |
| REGISTRATION_NO | NUMBER(6) | YES | | 수강신청 등록 번호 | 외래키 |
| EXAM_TYPE | VARCHAR2(50) | NO | | 시험종류 (중간, 기말, 레포트) | |
| EXAM_SCORE | NUMBER(3) | NO | | 시험성적 (0~100) | |
...
| SCHOOL_EXAMS | REGISTRATION_NO | 시험정보 등록시 해당 수강신청정보의 수강신청등록번호로 저장한다. |
